...
<div align="center" style="background-color: #80bfff;padding: 10px">
...
<?php if(isset($_GET['addstudent']) OR isset($_GET['batch'])) { ?>
    ...
    <?php if (isset($_GET['submit'])) {
        if ($_GET['batch'] != 'none') {
            ...
            ?>
            <div class="container">
    <div class="jumbotron" style="background-color:white;  margin-left:220px ; width:70%">
            <div align="center">
                <h3>Add Student</h3>
                <form method="post">
                    ...
                    <b>Date Of Reg:</b> <input type="date" name="dateofreg" required>
                    ...
                    &nbsp;&nbsp;<b>Paid Fees:</b> <input type="text" name="paidfee" placeholder="Paid Fees" required>
                    ...
                    &nbsp;&nbsp;<b>Center:</b> <input type="text" name="center" value="<?php echo ucfirst($center); ?>"
                                                      disabled>
                    <br><b>Class:</b> <input type="text" name="class" placeholder="Class" required>
                    ...
                    <hr width="80%">
                    <b>Father's Name:</b> <input type="text" name="fathername" placeholder="Father's Name" required>
                    &nbsp;&nbsp;<b>Occupation: </b><input type="text" name="fatheroccu"
                                                          placeholder="Father's Occupation">
                    &nbsp;&nbsp;<b>Mobile Number:</b> <input type="text" name="fathermob"
                                                             placeholder="Father's Mobile Number" required>
                    <br><b>Mother's Name:</b> <input type="text" name="mothername" placeholder="Mother's Name" required>
                    &nbsp;&nbsp;<b>Occupation: </b><input type="text" name="motheroccu"
                                                          placeholder="Mother's Occupation">
                    &nbsp;&nbsp;<b>Mobile Number:</b> <input type="text" name="mothermob"
                                                             placeholder="Mother's Mobile Number" required>
